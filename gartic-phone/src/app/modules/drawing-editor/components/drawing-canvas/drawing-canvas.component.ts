...
export class DrawingCanvasComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    if (this.canvasElement) {
      ...
      if (this.context) { CanvasUtils.initCanvas(canvasEl, this.context, this.width, this.height); }
    ...
    if (this.testCanvas) {
      ...
      if (this.testContext) {
        CanvasUtils.initCanvas( this.testCanvas.nativeElement, this.testContext, this.widthTestCanvas, this.heightTestCanvas);
      }
    }
  }
  ...
  private captureEvents(canvasEl: HTMLCanvasElement): void {
    this.mouseDownSubscription = fromEvent(canvasEl, 'mousedown')
      ...
      .subscribe((result) => {
        ...
        if (this.context) {
          CanvasUtils.drawLine({context: this.context, width: this.width, height: this.height}, prevPos, currentPos, this.color);
        }
      });
